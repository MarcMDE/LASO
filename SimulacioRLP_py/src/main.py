...
class BallInMazeDemo(ShowBase):
    ...
    def __init__(self):
        ...
        self.camera2_buffer = base.win.makeTextureBuffer("c2buffer", 512, 512, to_ram=True)
        ...
        self.camera2.setPosHpr(0, 0, 35, 0, -90, 0)
    ...
    def rollTask(self, task):
        #self.camera2_buffer.saveScreenshot("view.jpg")
